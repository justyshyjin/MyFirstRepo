...
<div class="pageheader clearfix">
	<h2 class="pull-left">
		<i class="fa fa-tag"></i> {{trans('customer::subscription.user')}} <span>{{trans('customer::subscription.edit_new_subscription')}}</span>
	</h2>
</div>
<form name="subscriptionForm" method="POST"
	action="{{url('admin/subscriptions-plans/update'.$subscriptions_plans->id)}}"
						...
						<div class="add_form clearfix">
							...
							<div class="form-group">
								...
								<select class="form-control mb10" name="is_active"
									data-ng-model="subscriptionCtrl.subscriptions_planst.is_active">
