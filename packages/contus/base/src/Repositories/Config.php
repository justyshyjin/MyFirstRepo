...
class Config implements ConfigInterface
{
    ...
    {
        return isset($this->config['hashNameCallback']) ? $this->config['hashNameCallback'] : '\Contus\Base\Repositories\Config::hashNameCallback';
    }
    ...
    {
        return isset($this->config['deleteChunksOnSave']) ? $this->config['deleteChunksOnSave'] : 1;
    }
