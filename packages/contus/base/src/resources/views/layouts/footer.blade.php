 <!-- footer -->
       <footer class="hop-media-footer clearfix">
         <div class="container no-padding">
          <div class="col-md-6 col-sm-6">
               <div class="hop-media-footer-inner">
              ...
              <div class="col-md-6 col-sm-6 text-right">
                 <ul class="hop-social-link">
                    <li><p>Follow us</p></li>
                    <li><a href="#"><i class="hopsprite hop-fb"></i></a></li>
                    <li><a href="#"><i class="hopsprite hop-twitter"></i></a></li>
                    <li><a href="#"><i class="hopsprite hop-linked"></i></a></li>
                    <li><a href="#"><i class="hopsprite hop-youtube"></i></a></li>
                 </ul>
              </div>
          </div>
       </footer>
