<div class="pagination_custom clearfix">
	<div class="input-group pull-left show_entries" data-ng-if="!filters.collectionId && !filters.categoryId">
                            <p>{{trans('base::general.show')}}</p>
                            ...
                            <p>{{trans('base::general.entries')}}</p>
                        </div>
