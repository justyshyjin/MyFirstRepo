...
@section('content')
 <div class="pageheader clearfix">
            <h2 class="pull-left">
                ...
                <span>{{trans('user::adminuser.add_new_user')}}</span>
            </h2>
        </div>
<form name="userForm" method="POST" action="{{url('admin/users/add')}}" enctype="multipart/form-data">
    {!! csrf_field() !!}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="{{trans('user::adminuser.username_placeholder')}}" value="{{old('name')}}" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="{{trans('user::adminuser.email_placeholder')}}" value="{{old('email')}}"/>
                                    <p class="help-block hide"></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="{{trans('user::adminuser.phone_placeholder')}}" value="{{old('phone')}}"/>
                                    <p class="help-block hide"></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mb10" name="is_active">
                                        ...
                                        <option @if(old('is_active') !== NULL && old('is_active') == 0) selected="selected" @endif value="0">{{trans('user::adminuser.inactive')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sex" class="form-control" placeholder="{{trans('user::adminuser.sex_placeholder')}}" value="{{old('sex')}}"/>
                                </div>
                            </div>
                        </div>
                        <hr>
