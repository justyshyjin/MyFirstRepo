...
<div class="contentpanel">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
          <form name="groupForm" method="POST" action="{{url('admin/groups/add')}}">
          {!! csrf_field() !!}
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input data-unique="{{url('admin/groups/unique')}}" type="text" name="name" class="form-control" placeholder="Group Name" value="{{old('name')}}" />
