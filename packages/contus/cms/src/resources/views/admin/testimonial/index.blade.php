...
<div data-ng-controller="testimonialController as testCtrl">
	...
	<div class="contentpanel product order_list">
		...
		<div data-grid-view data-rows-per-page="10"
			data-route-name="testimonial"
			data-template-route="admin/testimonial" data-count="false"></div>
	</div>
</div>
...
<script src="{{$getCmsAssetsUrl('js/testimonial/index.js')}}"></script>
