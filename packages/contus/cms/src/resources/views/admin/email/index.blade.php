...
<div data-ng-controller="emailController as emailCtrl">
	...
	<div class="contentpanel product order_list">
		...
		<div class="alert alert-success"
			data-ng-if="emailCtrl.showResponseMessage">
			<button type="button" class="close" data-dismiss="alert">�</button>
			<span>@{{emailCtrl.responseMessage}}</span>
		</div>
		<div data-grid-view data-rows-per-page="10" data-route-name="emails"
			data-template-route="admin/emails" data-count="false"></div>
	</div>
</div>
...
<script src="{{$getCmsAssetsUrl('js/email/index.js')}}"></script>
