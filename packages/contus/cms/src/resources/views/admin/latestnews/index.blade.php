...
<div data-ng-controller="latestNewsController as latestNewsCtrl">
	...
	<div class="contentpanel product order_list">
		...
		<div class="alert alert-success"
			data-ng-if="latestNewsCtrl.showResponseMessage">
			<button type="button" class="close" data-dismiss="alert">×</button>
			<span>@{{latestNewsCtrl.responseMessage}}</span>
		</div>
		<div data-grid-view data-rows-per-page="10" data-route-name="latest"
			data-template-route="admin/latest" data-count="false"></div>
	</div>
</div>
