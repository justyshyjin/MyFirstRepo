...
<form name="bannerForm" method="POST"
	action="{{url('admin/banner/update'.$banner->id)}}" enctype="multipart/form-data">
	{!! csrf_field() !!}
						...
						<div class="add_form clearfix">
							<div class="form-group"
								...
								<label class="control-label">{{trans('cms::staticcontent.title')}}
									...
									data-ng-model="bannerCtrl.banner.title"
									class="form-control"
							...
							<div class="form-group"
								data-ng-class="{'has-error': errors.url.has}">
								<label class="control-label">{{trans('cms::staticcontent.content')}}
									<span class="asterisk">*</span>
								</label>
								<textarea type="file" name="content" class="form-control"
									data-ng-model="bannerCtrl.banner.url"
									placeholder="{{trans('cms::staticcontent.content_placeholder')}}"
									value="{{old('url')}}"></textarea>
								<p class="help-block" hide"></p>
							</div>
							...
							<div class="form-group">
								...
								<select class="form-control mb10" name="is_active"
									data-ng-model="bannerCtrl.banner.is_active">
		...
		<div class="padding10">
			<div class="fixed-btm-action">
				<div class="text-right btn-invoice">
					<a class="btn btn-white mr5" href="{{url('admin/banner')}}">{{trans('base::general.cancel')}}</a>
...
<script src="{{$getCmsAssetsUrl('js/banner/banner.js')}}"></script>
