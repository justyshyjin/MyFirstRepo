...
<div data-ng-controller="smsController as smsCtrl">
	...
	<div class="contentpanel product order_list">
		...
		<div class="alert alert-success"
			data-ng-if="smsCtrl.showResponseMessage">
			<button type="button" class="close" data-dismiss="alert">×</button>
			<span>@{{smsCtrl.responseMessage}}</span>
		</div>
		<div data-grid-view data-rows-per-page="10"
			data-route-name="smsTemplate" data-template-route="admin/smsTemplate"
...
<script src="{{$getCmsAssetsUrl('js/sms/index.js')}}"></script>
