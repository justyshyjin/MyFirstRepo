                ...
                <table class="table playlist_table">
                    ...
                    <tbody>
                        ...
                        <td class="center" ng-show="!@{{record.customer}}">                         
                            ...
                            <td>
                                <span class="label label-success" ng-if="record.is_active == 1" style="cursor: pointer;" data-ng-click="qaCtrl.updateStatus(record)" title="{{trans('video::videos.deactivate_qa')}}" data-boot-tooltip="true">{{trans('video::playlist.message.active')}}</span>
                                <span class="label label-danger" ng-if="record.is_active != 1" style="cursor: pointer;" data-ng-click="qaCtrl.updateStatus(record)" title="{{trans('video::videos.activate_qa')}}" data-boot-tooltip="true">{{trans('video::playlist.message.inactive')}}</span>
                            </td>
