...
{{--        @if(Request::segment(2) == "livevideos")--}}
        ...
        {{--@else--}}
            <div data-grid-view data-rows-per-page="10" data-route-name="videos" data-template-route="admin/videos" data-request-grid="videos" data-count="false"></div>
        {{--@endif--}}
    </div>
    <div class="contentpanel clearfix add_video_container" id="video_frame">
        ...
        <form name="videoForm" enctype="multipart/form-data">
            <div id="file_drop_area" class="upload_video_container">
                ...
                <h2 id="preset_error" data-ng-show="vgridCtrl.numberOfActivePresets == 0">{{ __('video::videos.preset_error') }}</h2>
                <div data-ng-show="vgridCtrl.numberOfActivePresets > 0">
                    ...
                    <div id="video_upload_button_wrap" class="video_upload_div_btn">
                        <button class="btn btn-primary" type="button" title="{{ __('video::videos.upload') }}">{{ __('video::videos.upload') }}</button>
                    </div>
                </div>
            </div>
    ...
    <nav class="st-menu st-effect-7" id="menu-7">
        ...
        <div class="pop_over_continer">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#details" data-ng-click="vgridCtrl.setVideoEditRules()" data-toggle="tab">{{ __('video::videos.details') }}</a>
                </li>
                <li>
                    <a href="#video_presets" data-toggle="tab">{{ __('video::videos.presets') }}</a>
                </li>
                <li>
                    <a href="#video_thumbnails" data-ng-click="vgridCtrl.setThumbUploadRules()" data-toggle="tab">{{ __('video::videos.thumbnails') }}</a>
                </li>
            </ul>
                        ...
                        <form name="videoEditForm" method="POST" data-base-validator data-ng-submit="vgridCtrl.saveVideoEdit($event)" enctype="multipart/form-data">
                            <div class="video_form">
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.category_ids.has}">
                                    ...
                                    <div>
                                        <div class="admin_category_sub clearfix">
                                            <input type="text" class="form-control" data-ng-model="vgridCtrl.categoryField" placeholder="{{ __('video::videos.categories_place_holder') }}" data-ng-keyup="vgridCtrl.showCategoriesSuggestions($event)">
                                            <ul data-ng-if="vgridCtrl.categorySuggestions.length > 0" class="list_category">
                                                <li data-ng-repeat="suggestion in vgridCtrl.categorySuggestions" data-ng-click="vgridCtrl.addCategoriesToVideos(suggestion.id,suggestion.name)">@{{suggestion.name}}</li>
                                            </ul>
                                            <ul class="select_list_category">
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.short_description.has}">
                                    ...
                                    <input type="text" name="short_description" class="form-control" placeholder="{{ __('video::videos.short_description_placeholder') }}" data-ng-model="vgridCtrl.editVideo.short_description">
                                    <p class="help-block" data-ng-show="errors.short_description.has">@{{ errors.short_description.message }}</p>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">{{ __('video::videos.description') }}</label>
                            ...
                            <div class="panel-footer clearfix">
                                ...
                                &nbsp;
                                <a href="javascript:void(0)" class="btn btn-danger pull-right mr10" data-ng-click="vgridCtrl.closeVideoEdit()">{{ __('video::videos.cancel') }}</a>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="form-group" data-ng-class="{'has-error': errors.thumbnail.has}">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="input-append">
                                            ...
                                            <a href="#" class="btn btn-default fileupload-exists video-thumb-remove" data-dismiss="fileupload" data-ng-click="vgridCtrl.removeThumbnailProperty()">{{__('video::videos.remove')}}</a>
                                            <p class="help-block hide"></p>
                                        </div>
                                    </div>
                                    <p class="help-block" data-ng-show="errors.thumbnail.has">@{{ errors.thumbnail.message }}</p>
                                    <div class="form-group">
                                        <div class="clsFileUpload">
                                            <span id="thumb-delete" data-ng-click="vgridCtrl.deleteThumbnail();vgridCtrl.editVideo.selected_thumb = 'thumbnail_image'" data-ng-show="vgridCtrl.editVideo.thumbnail_image" data-boot-tooltip="true" title="{{__('video::videos.delete_thumbnail')}}">
                                                <i class="fa fa-remove" aria-hidden="true"></i>
                                            </span>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="clearfix modal-footer video_delete_footer">
                    ...
                    <span data-ng-click="vgridCtrl.confirmDeleteVideos('single-video')" class="btn btn-primary pull-right mr10" data-dismiss="modal">{{__('base::gridlist.confirm')}}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="clearfix modal-footer video_delete_footer" data-ng-show="vgridCtrl.isDeleteBulkRecord ">
                    <span data-ng-click="vgridCtrl.cancelDeleteVideos()" class="btn btn-danger pull-right" data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
                    <span data-ng-click="vgridCtrl.confirmDeleteVideos('bulk-video')" class="btn btn-primary pull-right mr10" data-dismiss="modal">{{__('base::gridlist.confirm')}}</span>
                </div>
                <div class="clearfix modal-footer video_delete_footer" data-ng-show="vgridCtrl.isActivateBulkRecord">
                    <span data-ng-click="vgridCtrl.cancelDeleteVideos()" class="btn btn-danger pull-right" data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
                    <span data-ng-click="vgridCtrl.confirmActivateOrDeactivateVideos(1)" class="btn btn-primary pull-right mr10" data-dismiss="modal">{{__('base::gridlist.confirm')}}</span>
                </div>
                <div class="clearfix modal-footer video_delete_footer" data-ng-show="vgridCtrl.isDeactivateBulkRecord">
                    <span data-ng-click="vgridCtrl.cancelDeleteVideos()" class="btn btn-danger pull-right" data-dismiss="modal">{{__('base::gridlist.cancel')}}</span>
                    <span data-ng-click="vgridCtrl.confirmActivateOrDeactivateVideos(0)" class="btn btn-primary pull-right mr10" data-dismiss="modal">{{__('base::gridlist.confirm')}}</span>
                </div>
            </div>
        </div>
    </div>
