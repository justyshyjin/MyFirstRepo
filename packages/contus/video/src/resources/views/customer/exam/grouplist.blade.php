        ...
        <div class="row">
            <nav class="breadcrumb" >
                ...
                <a class="breadcrumb-item">
                    <span> @{{group.exams.title}}</span>
                </a>
                <a class="breadcrumb-item" ui-sref="examList({slug:group.slug})">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="panel panel-default sub-widgets related-videos">
                        <div class="panel-heading common-header">Related Videos</div>
                        <div class="panel-body scrollfinderrelated" custom-scroll="{ 'autoHide': false }">
                            <div class="media" scrollfinder ng-repeat="video in related.data" ng-class="{'active':($root.stateParams.video === video.slug )}">
                                <div class="media-left">
                                    <a ui-sref="examdetail({slug:slug,video:video.slug})" title="@{{video.title}}">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">
                                        <a ui-sref="examdetail({slug:slug,video:video.slug})"  ng-click="passroute(video.slug)" title=" @{{video.title}}"> @{{video.title}}</a>
                                    </h4>
